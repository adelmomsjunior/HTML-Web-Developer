...
Precisamos saber quanto uma determinada empresa deve pagar para 
seus colaboradores, porém temos apenas a quantidade de horas 
...
recebe por hora e calcula o salário desse colaborador. Em seguida, 
...
var valor1 = parseInt(gets());
var valor2 = parseInt(gets());
var valor3 = parseFloat(gets());
var salary = parseFloat(valor2 * valor3).toFixed(2); 
